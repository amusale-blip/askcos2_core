...
class RetroChimeraTest(unittest.TestCase):
    """Test suite for RetroChimera retrosynthesis wrapper"""

    @classmethod
    def setUpClass(cls) -> None:
        cls.session = requests.Session()
        cls.base_url = f"{V2_HOST}:{V2_PORT}/api"
        cls.module_url = f"{V2_HOST}:{V2_PORT}/api/retro/retrochimera"
    ...
    def test_1(self):
        case_file = "tests/wrappers/retro/retro_retrochimera_test_case_1.json"
        ...
        if response_sync.get("status_code") == 200:
            ...
            if results and isinstance(results[0], dict):
                ...
                print("\nPredicted reactants from Vertex AI / RetroChimera:")
